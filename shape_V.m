...
% diag_weight={0,1}, default =1 (use diag)
...
function [mu1, Sig1, wt, AR, d2] = shape_V(X, scale_a, diag_weight, hard_threshold, initial)
...
if counter > itr
    display(['r_0: not converge at ',num2str(scale_a)])
end
